...
$sql_select = "SELECT id, orgao, status, reserva FROM pporto";
...
if (isset($_GET['delete_id'])) {
    ...
    $sql_delete = "DELETE FROM pporto WHERE id = $delete_id";
...
?>
<h2 style="text-align:center; color:#1E90FF">RELATÓRIO PORTO SEGUROS</h2>

<body>
    <table cellspadding="100" background-color="#1E90FF" style="width: 100%">
        <tr>
            <th style="color:#1E90FF">Indice</th>
            <th style="color:#1E90FF">Órgão</th>
            <th style="color:#1E90FF">Reserva</th>
            <th style="color:#1E90FF">Status</th>
            <th style="color:#1E90FF">Ações</th>
        </tr>
...
<meta http-equiv="refresh" content="0.5; URL='../painel_porto/painel.php' " />