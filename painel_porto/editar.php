...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
    $sql_select = 'SELECT * FROM pporto where id = ' . $_GET['id'];
...
<body style="background-color:	#1E90FF">
    <h2 style="text-align:center; color:#FFF">EDITAR PROCESSOS - PORTO SEGUROS</h2>
    ...
    <form action="editar.php?id=<?= $_GET['id'] ?>" method="post" enctype="multipart/form-data">
        ...
        <select name="status">
            <option value="protocolado" <?= ($status == 'protocolado') ? 'selected' : '' ?>>Protocolado</option>
    ...
    <div class="container" style="width: 100%">
        <div class="row">
            <div class="col">
                <img src="../image/porto.png" alt="PORTO SEGUROS" style="width: 50%; height: 50%; margin-left:350px">
            </div>
        </div>
