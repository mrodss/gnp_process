...
$sql_select = "SELECT id, orgao, status, reserva FROM pgente";
...
if (isset($_GET['delete_id'])) {
    ...
    $sql_delete = "DELETE FROM pgente WHERE id = $delete_id";
...
?>
<h2 style="text-align:center; color:steelblue">RELATÓRIO GENTE SEGURADORA</h2>
...
<meta http-equiv="refresh" content="0.5; URL='../painel_gente/painel.php' " />