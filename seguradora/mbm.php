...
<body style="background-color:steelblue">
    ...
    <h2 style="text-align:center; color:#FFF">PROCESSOS MBM SEGURADORA</h2>

    <form action="gerenciamento_mbm.php" method="post" enctype="multipart/form-data">
    ...
    <div class="container" style="width: 100%">
        <div class="row">
            <div class="col">
                <img src="../image/mbm.png" alt="MBM SEGURADORA" style="width: 50%; height: 50%; margin-left:350px">
            </div>
        </div>
