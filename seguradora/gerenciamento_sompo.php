...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (count($_SESSION['msgErr'])) {
		...
		$sql = "insert into psompo (orgao, reserva, status) values ('$orgao', '$reserva', '$status')";
...
?>
<meta http-equiv="refresh" content="0.2; URL='../painel_sompo/painel.php' " />