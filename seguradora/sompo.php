...
<body style="background-color:#B22222">
    ...
    <h2 style="text-align:center; color:#FFF">PROCESSOS SOMPO SEGUROS</h2>

    <form action="gerenciamento_sompo.php" method="post" enctype="multipart/form-data">
    ...
    <div class="container" style="width: 100%">
        <div class="row">
            <div class="col">
                <img src="../image/sompo.png" alt="SOMPO SEGUROS" style="width: 50%; height: 50%; margin-left:350px">
            </div>
        </div>
