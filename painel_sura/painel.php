...
$sql_select = "SELECT id, orgao, status, reserva FROM psura";
...
if (isset($_GET['delete_id'])) {
    ...
    $sql_delete = "DELETE FROM psura WHERE id = $delete_id";
...
?>
<h2 style="text-align:center; color:00CED1">RELATÓRIO SURA SEGUROS</h2>

<body>
    <table cellspadding="100" background-color="00CED1" style="width: 100%">
        <tr>
            <th style="color:00CED1">Indice</th>
            <th style="color:00CED1">Órgão</th>
            <th style="color:00CED1">Reserva</th>
            <th style="color:00CED1">Status</th>
            <th style="color:00CED1">Ações</th>
        </tr>
...
<meta http-equiv="refresh" content="0.5; URL='../painel_sura/painel.php' " />